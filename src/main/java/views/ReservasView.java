...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		labelExit.setForeground(Color.WHITE);
		labelExit.setBounds(-19, 0, 72, 36);
		...
		txtFechaEntrada.getCalendarButton().addPropertyChangeListener(new PropertyChangeListener() {
			...
			public void mouseClicked(MouseEvent e)  {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {	
						...
						try {
							...
							huesped.setCampo(campoReserva);
							System.out.println(campoReserva);
	 ...
	 private void guardarReserva () throws SQLException {
		 ...
		 JOptionPane.showMessageDialog(contentPane, "Registrado con éxito!");
		 
		 campoReserva=nuevaReserva.getId();
	 ...
	 private void calcularValor(JDateChooser txtFechaEntrada, JDateChooser txtFechaSalida) {
		 	...
		 	if (txtFechaEntrada.getDate()!=null && txtFechaSalida.getDate()!=null) {
		 		...
		 		Calendar fechae= txtFechaEntrada.getCalendar(); 
		 		Calendar fechas= txtFechaSalida.getCalendar();
		 		int dias=-1;
		 		
		 		while (fechae.before(fechas)|| fechae.equals(fechas)) {
		 			dias++;
		 			fechae.add(Calendar.DATE, 1);
		 		}
		 		double precio= dias*15.00;
		 		String precios = Double.toString(precio);
		 		txtValor.setText("$"+precios);
		 	}
