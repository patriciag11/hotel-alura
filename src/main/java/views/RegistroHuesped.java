...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if (txtNombre.getText() != null && txtApellido.getText()!= null && txtFechaN.getDate()!=null && txtNacionalidad.getSelectedItem()!= null && txtTelefono.getText()!=null ) {	
	...
	//Código que permite mover la ventana por la pantalla según la posición de "x" y "y"	
	 private void headerMousePressed(java.awt.event.MouseEvent evt) {
		...
		public void setCampo(int campoReserva) {
			idReserva= campoReserva;
			String id=String.valueOf(idReserva);
			txtNreserva.setText(id);
			
		}
		
		 private void guardarHuesped () throws SQLException {
			 String Fechan =((JTextField)txtFechaN.getDateEditor().getUiComponent()).getText();
			 
			 
			 Huesped nuevoHuesped = new Huesped (txtNombre.getText(), txtApellido.getText(),java.sql.Date.valueOf(Fechan),txtNacionalidad.getSelectedItem().toString(),txtTelefono.getText(), txtNreserva.getText());
